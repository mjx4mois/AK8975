...
*/
	...
	#define AK8975_SLAVE_ADDRESS 		(0x18)		/*Slave address*/
#elif (AK8975_CAD0_ADDR_PIN == 1)  && (AK8975_CAD1_ADDR_PIN == 0)
	#define AK8975_SLAVE_ADDRESS 		(0x1A)		/*Slave address*/
#elif (AK8975_CAD0_ADDR_PIN == 0)  && (AK8975_CAD1_ADDR_PIN == 1)
	#define AK8975_SLAVE_ADDRESS 		(0x1C)		/*Slave address*/
#elif (AK8975_CAD0_ADDR_PIN == 1)  && (AK8975_CAD1_ADDR_PIN == 1)
	#define AK8975_SLAVE_ADDRESS 		(0x1E)		/*Slave address*/
#endif
